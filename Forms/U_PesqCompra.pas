...
type
  TForm_PesqCompra = class(TForm_PesPadrao)
    ...
    qryPesqPadraoUSUARIO: TStringField;
    qryPesqPadraoID_FORMA_PAG: TIntegerField;
    qryPesqPadraoDESCRICAO: TStringField;
    qryPesqPadraoVALOR: TFMTBCDField;
    qryPesqPadraoCADASTRO: TDateField;
    qryPesqPadraoSTATUS: TStringField;
...
procedure TForm_PesqCompra.bt_TransferirClick(Sender: TObject);
begin
  inherited;
