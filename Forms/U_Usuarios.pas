...
begin
  ...
  begin
    MessageDlg('O usuário logado pode alterar somente seu usuário', TMsgDlgType.mtInformation, [TMsgDlgBtn.mbOK], 0);
  end;
end;
...
begin
  dbSenha.Text := Form_Utilitarios.CodificarSenha(dbSenha.Text);
    ...
    MessageDlg('Não foi possivel realizar esta operação.', mtInformation, [mbOk], 0);
  end;
