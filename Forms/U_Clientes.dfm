inherited Form_Clientes: TForm_Clientes
  ...
  object dbeCidadeCliente: TDBEdit [19]
    Left = 436
    Top = 166
    Width = 238
    Height = 21
  ...
  object RadioCNPJ: TRadioButton [25]
    Left = 729
    Top = 210
    Width = 42
    Height = 20
  ...
  object RadioCPF: TRadioButton [26]
    Left = 680
    Top = 211
    Width = 43
    Height = 17
  ...
  inherited qry_Padrao: TFDQuery
    ...
    object qry_PadraoCNPJ: TStringField
      FieldName = 'CNPJ'
      Origin = 'CNPJ'
      Required = True
    end
