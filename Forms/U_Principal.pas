...
type
  TForm_Principal = class(TForm)
    ...
    procedure Compas1Click(Sender: TObject);
...
procedure TForm_Principal.Compas1Click(Sender: TObject);
begin
  Form_Utilitarios.AbreTela(TForm_Compras, True);
end;
...
begin
  MessageDlg('Versão de Estudo 1.0 by: Lucas Marcelino Lara', TMsgDlgType.mtInformation, [TMsgDlgBtn.mbOK], 0);
end;
...
begin
  ...
  StatusBar1.Panels[2].Text := 'Seja Bem-Vindo ao Sistema - Usuário logado: ' + UpperCase(Form_Login.usuarioLogado);
end;
...
procedure TForm_Principal.SpeedButton7Click(Sender: TObject);
begin
  Form_Utilitarios.AbreTela(TForm_Compras, True);
end;

procedure TForm_Principal.SpeedButton8Click(Sender: TObject);
begin
  Form_Utilitarios.AbreTela(TForm_Vendas, True);
end;
