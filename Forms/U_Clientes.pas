...
type
  TForm_Clientes = class(TForm_Padrao)
    ...
    procedure dbeCidadeClienteExit(Sender: TObject);
  private
...
procedure TForm_Clientes.dbeCidadeClienteExit(Sender: TObject);
begin
  inherited;
  dbeCidadeCliente.Text :=  UpperCase(dbeCidadeCliente.Text);
end;
